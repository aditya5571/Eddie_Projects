...
{	
    ...
    * 
    * IMPORTANT NOTE 1: At the end of the round but before calling {@link GameEngineCallback#houseResult(int, GameEngine)} 
    ...
    * @param houseResult - the calculated house result
    * </pre>
    */
