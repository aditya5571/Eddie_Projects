...
public class GameEngineCallbackImpl implements GameEngineCallback {
	...
	public void nextCard(Player player, PlayingCard card, GameEngine engine) {
		...
		logger.log(Level.INFO,
				String.format("Card Dealt to %s .. %s", 
	...
	public void bustCard(Player player, PlayingCard card, GameEngine engine) {
		logger.log(Level.INFO,
				String.format("Card Dealt to %s .. %s ... YOU BUSTED!", 
						player.getPlayerName(), card.toString()));
	}
	...
	public void result(Player player, int result, GameEngine engine) {
		...
		logger.log(Level.INFO,
				String.format("%s, final result=%d",
						player.getPlayerName(), player.getResult()));
	}
	...
	public void nextHouseCard(PlayingCard card, GameEngine engine) {
		logger.log(Level.INFO,
				String.format("Card Dealt to House .. %s",
						card.toString()));
	}
	...
	public void houseBustCard(PlayingCard card, GameEngine engine) {
		logger.log(Level.INFO,
				String.format("Card Dealt to House .. %s ... HOUSE BUSTED!", 
						card.toString()));
	}
	...
	public void houseResult(int result, GameEngine engine) {
		logger.log(Level.INFO, 
				String.format("House, final result=%d", result));
		
		ArrayList<Player> allPlayers = (ArrayList<Player>) engine.getAllPlayers();
		String str = "";
		for (int i = 0; i < allPlayers.size(); i++) {
			str += allPlayers.get(i);
			str += "\n";
		}
